...
const Skills = () => {
  ...
  return (
    ...
    >
      ...
      <Wrapper>
        {/* SKILL ICONS START */}
        <Div className="grid grid-cols-2 gap-8 md:grid-cols-7 relative ml-[15%]">
          <SkillIcon path={sk8} />
          <SkillIcon path={sk9} />
          <SkillIcon path={sk10} />
          <SkillIcon path={sk11} />
        ...
        <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
          ...
          <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
            <Service
              ...
              desc="A goal-oriented Frontend Developer with knowledge of HTML, CSS, JavaScript and React seeking to use technical proficiency and creativity to develop engaging user experiences and advance in a professional career. Looking to leverage effective debugging, code optimization and project collaboration capabilities to produce applications that exceed user expectations."
              data={["HTML", "CSS", "Javascript", "Typescript", "ReactJs"]}
            />
            <Service
              num="2"
              title="React Development"
              desc="Passionate and detail-oriented aspiring ReactJS Developer with a strong foundation in JavaScript, HTML, and CSS. Eager to contribute to a dynamic development team and build innovative web applications."
              data={["ReactJS", "Redux", "REST API"]}
            />
            {/* <Service
              num="3"
              title="Frontend Development"
