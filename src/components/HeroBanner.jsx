      ...
      <Wrapper>
        ...
        >
          <div className="flex items-center gap-[6px]">
            ...
            <div>abhishekmahur05@gmail.com</div>
          </div>
        ...
        >
          ...
          <div className="max-w-[510px]">
            ...
            and JavaScript, eager to contribute my skills and creativity to a
            dynamic web development team. Committed to delivering visually
            appealing, user-friendly websites and applications.
          </div> */}
        </motion.div>
        {/* INTRO END */}
